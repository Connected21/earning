...
var Counter = {
    ...
    Stop: function()
    {
        ...
        localStorage.setItem("total_score",(this.Score !== "00" && this.Score < 10 ? "0" : "") + this.Score); // this will store the score on browser's local storage
...
document.addEventListener('DOMContentLoaded', function()
{
    ...
    {
        Counter.Initialize(20); // this is the time limit
